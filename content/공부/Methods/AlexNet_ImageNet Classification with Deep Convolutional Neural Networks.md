...
- **대규모 데이터(ImageNet) + GPU 병렬 연산 + 개선된 [[Convolutional Neural Network]] 구조**로 이를 해결하고자 함
...
### 주요 아이디어
![[Pasted image 20260623093648.png]]
...
- 주요 기법:
    - **ReLU Nonlinearity (Rectifies Linear Unit)** 
		...
		- 특히 GPU 병렬 학습 환경에서 연산 효율이 매우 높아, **대규모 [[Convolutional Neural Network]] 학습을 실질적으로 가능하게 한 핵심 요인**이 되었음.
